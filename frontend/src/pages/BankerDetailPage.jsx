    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-20 sm:pt-24 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <button
            onClick={() => navigate(-1)}
            className="mb-4 sm:mb-6 px-4 sm:px-6 py-2.5 sm:py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold text-sm sm:text-base rounded-xl hover:border-gray-400 transition inline-flex items-center gap-2"
          >
            <span>←</span> Back
          </button>
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-[#39b385] to-[#9be15d] rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 mb-6 sm:mb-8 text-white">
                <div className="flex items-start justify-between mb-4 sm:mb-6">
                  <div>
                    <p className="text-white/80 text-xs sm:text-sm mb-2">Account Holder</p>
                  ...
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-4xl">
                ...
                <div>
                  <p className="text-white/80 text-xs sm:text-sm mb-2">Current Balance</p>
                  ...
                  <>
                    <div className="space-y-2 sm:space-y-3">
                      {account.transactions.map((t, idx) => (
                        <div
                          key={idx}
                          className="flex items-center justify-between p-3 sm:p-4 md:p-5 bg-gray-50 rounded-xl sm:rounded-2xl border border-gray-100"
                        >
